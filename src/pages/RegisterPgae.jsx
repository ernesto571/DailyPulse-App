  ...
  return (
    <div className="h-screen bg-gray-100 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 h-[90%]">
        ...
        <section className="grid grid-cols-1 justify-center bg-white px-8 max-h-[95%] mt-[5%] w-[70%] ml-[15%] rounded-[20px]">
          <div className="max-w-md w-full">
            <h1 className="text-[1.5rem] text-center font-bold text-gray-800 my-6">Create an account</h1>
