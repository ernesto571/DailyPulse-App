...
function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (success === true) {
      signup(formData); // ✅ Use the signup function from store
      navigate("/")
    }
  };
  ...
  return (
    <div className="h-screen bg-gray-100 overflow-hidden">
      <div className="grid grid-cols-1 md:grid-cols-2 h-[90%]">
        {/* Left Side */}
        <section className="hidden lg:flex items-center justify-center px-8">
          <div className="max-w-md w-full">
            ...
            <p className="mt-1 mb-3 font-semibold text-xl text-gray-800">
              Free registration on <span className="text-red-800">DailyPulse</span> gives you:
            </p>

            <ul className="space-y-3 text-gray-700 font-medium">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-red-800 flex-shrink-0 mt-0.5" />
                <span>Unlimited access to global and local news coverage</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-red-800 flex-shrink-0 mt-0.5" />
                <span>Personalized "My Feed" for topics, authors, and trends you care about</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-red-800 flex-shrink-0 mt-0.5" />
                <span>Industry-focused newsletters delivered straight to your inbox</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-red-800 flex-shrink-0 mt-0.5" />
                <span>Access from anywhere with the DailyPulse App</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-red-800 flex-shrink-0 mt-0.5" />
                <span>Ability to save and manage articles with Bookmarks</span>
              </li>
            </ul>
        ...
        <section className="grid grid-cols-1 justify-center bg-white px-8 max-h-[85%] mt-[10%] w-[70%] ml-[15%] rounded-[20px]">
          <div className="max-w-md w-full">
            <h1 className="text-3xl text-center font-bold text-gray-800 my-6">Create an account</h1>
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white border-2 border-gray-300 hover:border-gray-400 hover:shadow-md text-gray-700 font-semibold rounded-lg shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed">
              ...
              <p className="text-center text-sm text-gray-600 my-4">
                ...
                <a href="/login" className="text-red-700 font-medium hover:text-red-800 underline">
                  Sign in
                </a>
              </p>
            </div>
